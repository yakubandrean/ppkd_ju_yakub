...
enum MenuItem { Tugas8, Tugas9 }

class Tugas9 extends StatefulWidget {
  const Tugas9({Key? key}) : super(key: key);

  @override
  _Tugas9State createState() => _Tugas9State();
}

class _Tugas9State extends State<Tugas9> {
  MenuItem _selectedMenu = MenuItem.Tugas8;

  final Map<MenuItem, String> _titles = {
    MenuItem.Tugas8: 'Tugas 8',
    MenuItem.Tugas9: 'Tugas 9',
  };
  ...
  static const List<Widget> _pages = [Tugas8(), Tugas9()];
          ...
          children: [
            const DrawerHeader(
              ...
              child: Column(
                ...
                children: [Icon(Icons.api)],
              ),
            ),
            ListTile(
              leading: const Icon(Icons.book_online_sharp),
              title: const Text('Tugas 8'),
              selected: _selectedMenu == MenuItem.Tugas8,
              onTap: () => _selectMenu(MenuItem.Tugas8),
            ),
            ListTile(
              leading: const Icon(Icons.book_online_sharp),
              title: const Text('Tugas 9'),
              selected: _selectedMenu == MenuItem.Tugas9,
              onTap: () => _selectMenu(MenuItem.Tugas9),
            ),
          ],
        ),
      ),
